...
class CompleteLinkageTest {
	...
	void singleElementClustersWithSymmetricSimilarity() throws Exception {
		...
		Linkage linkage = new CompleteLinkage(builder.build());
	...
	void singleAndNonSingleElementClustersWithSymmetricSimilarity() throws Exception {
		...
		Linkage linkage = new CompleteLinkage(builder.build());
		assertEquals(this.dotTwo, linkage.evaluate(this.alphaBetaCluster, this.gammaCluster).stripTrailingZeros());
	}
	...
	void nonSingleElementClustersWithSymmetricSimilarity() throws Exception {
		...
		Linkage linkage = new CompleteLinkage(builder.build());
		assertEquals(this.dotTwo, linkage.evaluate(this.alphaBetaCluster, this.gammaDeltaCluster).stripTrailingZeros());
	}
	...
	void singleElementClustersWithAsymmetricSymilarityWithTheDistinctValues() throws Exception {
		...
		Linkage linkage = new CompleteLinkage(builder.build());
		assertEquals(this.dotTwo, linkage.evaluate(this.alphaCluster, this.betaCluster));
	}
